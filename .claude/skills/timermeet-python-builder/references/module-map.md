...
| `timermeet_app/alarm_ui.py` | The persistent alarm overlay + title-bar blink (`AlarmController`) -- the single on-screen alert window | Business logic about which meeting fires next (that's `app.py`) |
